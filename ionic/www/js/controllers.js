...
myApps.controller('AppCtrl', function ($scope, $ionicModal, $ionicPopup, $timeout, $ionicLoading, $http, $httpParamSerializerJQLike) {
...
myApps.controller('PlaylistsCtrl', function ($scope) {
  $scope.playlists = [
    {title: 'Reggae', id: 1},
    {title: 'Chill', id: 2},
    {title: 'Dubstep', id: 3},
...
myApps.controller('PlaylistCtrl', function ($scope, $stateParams) {
});
